...
export function AdminOrdersPortal() {
  ...
  const metrics = useMemo(() => {
    const validOrders = orders.filter((order) => order.status !== 'rechazado' && order.status !== 'cancelado')
    return {
      total: orders.length,
